...
namespace OnlineEducationPlatform.BLL.Manager.ExamResultmanager
{
    public class examresultmanager : IExamResultmanager
    {
        ...
        public async Task<ServiceResponse<Examresultreaddto>> GetExamResultAsync(string studentid, int examid)
        {
            ...
            var response = new ServiceResponse<Examresultreaddto>();
            ...
            else
            {
                ...
                response.Data = new Examresultreaddto
                {
                    id = examresult.Id,
                    studentId = examresult.StudentId,
                    Examid = examresult.ExamId,
