...
namespace OnlineEducationPlatform.BLL.Manager.quizresultmanager
{
    public class QuizResultManager : IQuizResultManager
    {
        ...
        public async Task<ServiceResponse<quizresultreaddto>> GetQuizResultAsync(string studentid, int quizid)
        {
            ...
            var response = new ServiceResponse<quizresultreaddto>();
            ...
            else
            {
                ...
                response.Data = new quizresultreaddto
                {
                    id = quizresult.Id,
                    studentId = quizresult.StudentId,
                    QuizId = quizresult.QuizId,
